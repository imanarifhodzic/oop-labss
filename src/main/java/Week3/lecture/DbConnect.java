...
public class DbConnect {
    ...
    private static final String PASSWORD = "imamelse2203";
    ...
    public void getCustomerById(int customerId) throws SQLException {
        ...
        ResultSet rs = statement.executeQuery();
        while (rs.next()) { System.out.println(rs.getString("customerNumber")); System.out.println(rs.getString("customerName"));
        } }
}
